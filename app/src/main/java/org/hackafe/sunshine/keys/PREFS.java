package org.hackafe.sunshine.keys;

public class PREFS {
    public static final String KEY_CURRENT_LOCATION_NAME = "sett_location";
    public static final String KEY_CURRENT_UNIT_SYSTEM = "sett_unit_system";
